...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let headingBoxH1 = document.querySelector(".headingBox h1");
    if (headingBoxH1) {
        headingBoxH1.textContent = categoryData.name;
    }
    let sideHeadingBoxes = document.querySelectorAll(".sideHeadingBox");
...
function createBenefitBox() {
    const linkContainer = Array.from(document.getElementsByClassName("popular-benefits"));
    let htmlDataBenefit = "";
