...
const benefits = [
  {
    ...
    icon: "fas fa-piggy-bank",
    description:
      "A retirement savings scheme mandatory for large organizations.",
    content:
      "<p>A social security benefit for employees.</p><p>Eligibility: Mandatory for organizations with 20 or more employees.</p><p>Contribution: Both employee and employer contribute 12% of the employee’s monthly salary.</p><p>Voluntary Provident Fund: Employees can contribute up to 100% of their basic salary and DA.</p><p>How to Avail: Automatically deducted and managed by the employer.</p>",
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          "Both employee and employer contribute 12% of the employee’s monthly salary.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes, employees can contribute up to 100% of their basic salary and DA under the Voluntary Provident Fund.",
      },
    ],
  ...
  },
  {
    ...
    content:
      "<p>Provides medical, maternity, disability, and dependents benefits.</p><p>Eligibility: Mandatory for employees earning up to INR 21,000 per month.</p><p>Contribution: Employee contributes 0.75% and employer contributes 3.25%.</p><p>How to Avail: Automatically deducted and managed by the employer.</p>",
    faqs: [
      {
        question: "What is ESI?",
        answer:
          "ESI provides medical, maternity, disability, and dependents benefits.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Employee contributes 0.75% and employer contributes 3.25% of the employee’s salary.",
      },
      {
        question: "How are ESI benefits availed?",
        answer:
          "ESI benefits are automatically deducted and managed by the employer.",
      },
    ],
    categoryId: "statutory-benefits",
    views: 120,
  },
  {
    ...
    content:
      "<p>Provides various welfare benefits including pensions and maternity benefits.</p><p>Contribution: INR 50 per month.</p><p>How to Avail: Automatically deducted and managed by the employer.</p>",
    faqs: [
      {
        question: "What is Labour Welfare Fund?",
        answer:
          "It provides various welfare benefits including pensions and maternity benefits.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "The fund is automatically deducted and managed by the employer.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "They include various types of leaves such as sick leave, casual leave, and maternity leave.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Statutory leaves can be availed through the leave application process in the employee portal.",
      },
      {
  ...
  },
  {
    ...
    description:
      "A lump sum payment given to employees after 5 years of service.",
    content:
      "<p>A lump sum payment to employees who have served for at least 5 years.</p><p>Calculation: (Last drawn Basic + DA) * 15/26 * Number of years of service.</p><p>How to Avail: Automatically processed upon eligibility.</p>",
    faqs: [
      {
        question: "What is gratuity?",
        answer:
          "A lump sum payment to employees who have served for at least 5 years.",
      },
      {
        question: "How is gratuity calculated?",
        answer:
          "Gratuity is calculated as (Last drawn Basic + DA) * 15/26 * Number of years of service.",
      },
      {
        question: "When is gratuity paid out?",
        answer:
          "Gratuity is automatically processed upon eligibility after 5 years of service.",
      },
      {
  ...
  },
  {
    ...
    description:
      "Tax-free benefits provided to employees under the old tax regime.",
    content:
      "<p>Tax-free benefits under the old tax regime.</p><p>Providers: Happay and Sodexo.</p><p>Options:</p><ul><li>Meal Cards: Rs. 1000, Rs. 2200, Rs. 3000/month</li><li>Fuel Cards: Rs. 900 (two-wheeler), Rs. 1800 (small car), Rs. 2400 (large car)</li></ul><p>How to Avail: Register quarterly; employee must own the vehicle for fuel card.</p>",
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          "Employees need to register quarterly and own the vehicle for the fuel card.",
      },
      {
  ...
  },
  {
    ...
    icon: "fas fa-plane",
    description:
      "A benefit offering tax exemptions for travel expenses during leave.",
    content:
      "<p>Tax exemptions for travel expenses during leave.</p><p>Eligibility: Exemptions up to 10% of basic salary; domestic travel only.</p><p>How to Avail: Submit proofs of travel expenses.</p>",
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          "Exemptions are up to 10% of basic salary and for domestic travel only.",
      },
      {
  ...
  },
  {
    ...
    description:
      "A tax exemption for employees using mobile/internet for work purposes.",
    content:
      "<p>Tax exemption for employees using mobile/internet for work.</p><p>Eligibility: Employee must have the connection in their name.</p><p>How to Avail: Submit monthly claims up to Rs. 1500.</p>",
    faqs: [
      {
        question: "What is Mobile/Internet Allowance?",
        answer:
          "It provides tax exemption for employees using mobile/internet for work.",
      },
    ],
    categoryId: "tax-saving-benefits",
    views: 95,
  },
  {
    ...
    content:
      "<p>A voluntary retirement saving scheme.</p><p>Contribution: Employer can contribute up to 10% of annual basic pay.</p><p>How to Avail: Register through HDFC or provide existing NPS account details.</p>",
    faqs: [
      {
  ...
  },
  {
    ...
    icon: "fas fa-medkit",
    description:
      "An insurance scheme covering hospitalization expenses for employees and their families.",
    content:
      "<p>Covers hospitalization expenses.</p><p>Coverage: Employee, spouse, and three children.</p><p>How to Avail: E-cards available on MediAssist portal.</p>",
    faqs: [
      {
